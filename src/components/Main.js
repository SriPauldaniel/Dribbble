...
function Main() {
    return(
        <div className="relative h-[480px]">
            <div className="absolute z-20 flex h-full max-w-full flex-col justify-center space-y-4 ml-12 font-bold text-white ">
                ...
                <h1 className='text-7xl flex max-w-full  mx-auto pt-[25px] font-Century font-md'>Work with the world's top</h1>
